...
public class Problem {
	...
	@ApiModelProperty(example = "2023-06-30T20:17:06.1252302Z", position = 5)
	...
	@ApiModelProperty(example = "Um ou mais campos estão inválidos. Faca o preenchimento correto e tente novamente.", 
			position = 20)
